...
class TestLicensePlateRecognition(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.charges_df = pd.read_csv('data/charges_Schroeder/charges.csv', delimiter=',')
        self.results_api_df = pd.read_csv('data/vision_api_results_filename.csv', delimiter=';')
